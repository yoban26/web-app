        ...
        <div class="panel panel-info">
          <div class="panel-heading">
            <div class="btn-group pull-right">
              <button type='button' class="btn btn-info" data-toggle="modal" data-target="#NewTipoUsuarioModal"><span class="glyphicon glyphicon-plus" ></span> Nuevo Tipo Usuario</button>
            </div>
            <h4><i class='glyphicon glyphicon-edit'></i> Tipos de Usuarios del Sistema</h4>
          </div>
