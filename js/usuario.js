function guardar_usuario(){
    ...
    if(nombre == ""){
        ...
        document.getElementById("show_error").innerHTML = error;
            ...
            conexion.open("POST","ajax/usuario.php",true);
            conexion.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            conexion.send("nombre="+nombre+"&apellido="+apellido+"&username="+username+"&password="+pass_conf+"&estado="+estado+"&id_rol="+id_rol+"&id_region="+id_region+"&id_cliente="+id_cliente);
        }
    }
}
